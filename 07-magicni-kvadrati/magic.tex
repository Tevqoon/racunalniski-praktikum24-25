...
% To naredite tako, da pred ukazom `\title` dodate ukaz `\date{}`.
...
\begin{definicija}
   \pemph{Magični kvadrat} reda $n$ je nabor $n^2$ različnih števil,
...
\begin{definicija}
   Magični kvadrat reda $n$ je \pemph{normalen}, če v njem nastopajo števila
   \begin{equation}
      % oznaka: eq:numbers
...
\pemph{Lo Shu} -- ">zvitek reke Lo"<. V antični Kitajski je prišlo do
...
\pemph{Kubera-Kolam} je talna poslikava, ki se uporablja v Indiji, in je v
...
\begin{definicija}
      ...
      v magičnem kvadratu imenujemo \pemph{magična konstanta}.
\end{definicija}
...
\begin{definicija}
      Pravimo, da sta dva magična kvadrata \pemph{različna}, če enega ni mogoče dobiti
...
\begin{table}
   ...
   \begin{tabular}{|l|c|c|c|c|c|c|}
      ...
      število kvadratov & 1 & 0 & 1 & 880 & 275305224 & 123 \\ \hline
         \end{tabular}
\end{table}
% Konec tabele
...
\begin{magic}{5}{Magični kvadrat reda 5}{table:mag5}
   %[5][Magični kvadrat reda 5][table:mag5]
   17 & 24 &  1 &  8 & 15 \\\hline
   23 &  5 &  7 & 14 & 16 \\\hline
    4 &  6 & 13 & 20 & 22 \\\hline
   10 & 12 & 19 & 21 &  3 \\\hline
